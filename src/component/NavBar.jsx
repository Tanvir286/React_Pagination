        ...
        <div className='border-b border-slate-200'> 
              <div className='container mx-auto'>
               <ul className='flex justify-between text-[17px] font-dm py-3  px-3 '>
                ...
                <li className='hover:text-primary cursor-pointer' >Phone</li>
                <li className='hover:text-primary cursor-pointer' >Tablet</li>
                <li className='hover:text-primary cursor-pointer' >Office Equiment</li>
                <li className='hover:text-primary cursor-pointer' >Camera</li>
